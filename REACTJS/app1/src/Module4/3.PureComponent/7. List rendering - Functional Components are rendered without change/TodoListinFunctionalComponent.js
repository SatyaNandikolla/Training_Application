...
import WithoutChangeinFunctionalComponent from './WithoutChangeinFunctionalComponent';

export default function TodoListinFuunctionalComponent() {
    ...
    return (
        <div>
            {
                todoList.map( todo => <WithoutChangeinFunctionalComponent key={ todo.id } todo={ todo } /> )
            }

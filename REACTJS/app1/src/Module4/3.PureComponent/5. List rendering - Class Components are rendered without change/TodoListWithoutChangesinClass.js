...
import ListRenderingWithoutChangesinClass from './ListRenderingWithoutChangesinClass';


export default function TodoListWithoutChangesinClass() {
    ...
    return (
        <div>
            {
                todoList.map( todo => <ListRenderingWithoutChangesinClass key={ todo.id } todo={ todo } /> )
            }
